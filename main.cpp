...
int main(int argc, char **argv)
{
    ...
    */
    ...
    prodEntityArgs genProdArgs{&(*monitor), &(*genProd)}; //Start our general request argument structure
    prodEntityArgs vipProdArgs{&(*monitor), &(*vipProd)}; // Start our vip request arguemtns structure
    consEntityArgs robTxArgs{&(*monitor), &(*robTx)}; //Start our TX robot agument structure
    consEntityArgs robRevArgs{&(*monitor), &(*robRev)}; //Start our Rev9  argument structure
